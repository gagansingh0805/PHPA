  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-3xl shadow-2xl rounded-2xl bg-zinc-950/95 border border-purple-500/40 backdrop-blur-xl overflow-hidden select-none"
      >
        ...
        <div className="p-4 sm:p-5">
          ...
          <div className="flex items-center justify-between gap-3 mb-2.5">
            <div className="flex items-center gap-2">
              <span className="flex items-center gap-1 text-[11px] font-mono font-bold text-purple-400 uppercase tracking-wider">
                <Sparkles className="w-3.5 h-3.5" />
                <span>Showcase Step {step + 1} of {totalSteps}</span>
              </span>
              <span className={`text-[10px] font-mono font-semibold px-2 py-0.5 rounded-full border ${tagColor}`}>
                {tag}
              </span>
            </div>

            <div className="flex items-center gap-2">
              <div className="flex items-center gap-1 font-mono text-xs text-zinc-400 bg-zinc-900/90 px-2 py-0.5 rounded border border-zinc-800">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-zinc-900/90 gap-4">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                onClick={onNext}
                className="px-2.5 py-1.5 rounded-lg bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-zinc-300 hover:text-white text-xs font-semibold flex items-center gap-1 transition-colors"
                title={step === totalSteps - 1 ? 'Finish Demo' : 'Next Demo Step'}
              >
                <span className="hidden sm:inline">{step === totalSteps - 1 ? 'Finish' : 'Next'}</span>
