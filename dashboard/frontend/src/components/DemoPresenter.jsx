  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed top-16 right-3 sm:right-6 z-50 w-[340px] sm:w-[380px] max-h-[calc(100vh-4.8rem)] flex flex-col rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-2xl overflow-hidden select-none"
      >
        ...
        <div className="p-3.5 sm:p-4 overflow-y-auto space-y-3 flex-1">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex items-center gap-1.5 flex-shrink-0">
              ...
              <button
                onClick={onExit}
                className="w-6 h-6 rounded bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 border border-zinc-200 dark:border-zinc-700 flex items-center justify-center text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-colors"
          ...
          <div className="rounded-lg p-3 bg-zinc-50 dark:bg-zinc-950/80 border border-zinc-200 dark:border-zinc-800 space-y-1.5">
            ...
            <div className="pt-1 flex items-center gap-1 text-[10px] font-mono text-zinc-500 dark:text-zinc-400">
        ...
        <div className="p-3 bg-zinc-50/70 dark:bg-zinc-950/70 border-t border-zinc-200 dark:border-zinc-800 flex-shrink-0 space-y-2">
          <div className="flex items-center justify-between gap-2">
            {/* 5 Stage Step Dots */}
                ...
                <div
                  ...
                  className={`h-1.5 rounded-full transition-all duration-300 ${
                    i === step
                      ...
                      : 'w-1.5 bg-zinc-200 dark:border dark:border-zinc-700 bg-transparent'
                  }`}
                />
              ))}
            </div>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <button
                ...
                className="px-3 py-1 rounded bg-zinc-900 hover:bg-zinc-800 dark:bg-zinc-100 dark:hover:bg-white text-white dark:text-zinc-900 font-semibold text-xs flex items-center gap-1.5 shadow-sm transition-all"
              ...
              <button
                onClick={onNext}
                className="px-2.5 py-1 rounded bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 text-xs font-semibold flex items-center gap-1 transition-colors"
          ...
          {/* Helper Keyboard Shortcut Hint */}
          <div className="text-[10px] font-mono text-zinc-400 dark:text-zinc-500 text-center flex items-center justify-center gap-2">
