...
import (
	...
	"github.com/gagansingh0805/predictive-horizontal-pod-autoscaler/internal/algorithm"
	"github.com/gagansingh0805/predictive-horizontal-pod-autoscaler/internal/controllers"
	"github.com/gagansingh0805/predictive-horizontal-pod-autoscaler/internal/hook/http"
...
func init() {
	...
	utilruntime.Must(phpav1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a07591f8.gagansingh.dev",
