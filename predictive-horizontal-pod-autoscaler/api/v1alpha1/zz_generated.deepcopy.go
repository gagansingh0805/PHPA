...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LSTM) DeepCopyInto(out *LSTM) {
	*out = *in
	if in.ModelPath != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LSTM.
func (in *LSTM) DeepCopy() *LSTM {
	if in == nil {
		return nil
	}
	out := new(LSTM)
