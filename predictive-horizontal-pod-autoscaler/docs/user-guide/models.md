...
`/examples/simple-linear`](https://github.com/gagansingh0805/PHPA/tree/master/examples/simple-linear).
...
requires tweaking and analysis to be able to optimise. See [here](https://en.wikipedia.org/wiki/Exponential_smoothing) or
...
For a more detailed example, [see the example in
`/examples/simple-holt-winters`](https://github.com/gagansingh0805/PHPA/tree/master/examples/simple-holt-winters).
...
> [#89](https://github.com/gagansingh0805/PHPA/issues/89).
...
For a more detailed example, [see the example in
`/examples/dynamic-holt-winters`](https://github.com/gagansingh0805/PHPA/tree/master/examples/dynamic-holt-winters).
