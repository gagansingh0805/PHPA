...
type Predicter interface {
	GetPrediction(model *phpav1alpha1.Model, replicaHistory []phpav1alpha1.TimestampedReplicas) (int32, error)
	PruneHistory(model *phpav1alpha1.Model, replicaHistory []phpav1alpha1.TimestampedReplicas) ([]phpav1alpha1.TimestampedReplicas, error)
	GetType() string
}
...
func (m *ModelPredict) GetPrediction(model *phpav1alpha1.Model, replicaHistory []phpav1alpha1.TimestampedReplicas) (int32, error) {
...
func (m *ModelPredict) PruneHistory(model *phpav1alpha1.Model, replicaHistory []phpav1alpha1.TimestampedReplicas) ([]phpav1alpha1.TimestampedReplicas, error) {
	for _, predicter := range m.Predicters {
		if predicter.GetType() == model.Type {
