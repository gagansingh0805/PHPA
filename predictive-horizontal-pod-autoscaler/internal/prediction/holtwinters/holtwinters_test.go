...
func TestPredict_GetPrediction(t *testing.T) {
	...
	var tests = []struct {
	...
	}{
		{
			...
			&holtwinters.Predict{},
			&phpav1alpha1.Model{},
			[]phpav1alpha1.TimestampedReplicas{},
		},
		{
			...
			&holtwinters.Predict{},
			&phpav1alpha1.Model{
				Type: phpav1alpha1.TypeLinear,
				HoltWinters: &phpav1alpha1.HoltWinters{
					Trend: "",
				},
			},
			[]phpav1alpha1.TimestampedReplicas{},
		...
		},
		{
			...
			&holtwinters.Predict{
				HookExecute: func() *fake.Execute {
					...
					execute.ExecuteWithValueReactor = func(definition *phpav1alpha1.HookDefinition, value string) (string, error) {
			...
			&phpav1alpha1.Model{
				HoltWinters: &phpav1alpha1.HoltWinters{
					RuntimeTuningFetchHook: &phpav1alpha1.HookDefinition{
						Type:    "test",
						Timeout: 2500,
					},
					SeasonalPeriods: 2,
