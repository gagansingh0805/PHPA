...
import (
	...
	"github.com/gagansingh0805/predictive-horizontal-pod-autoscaler/internal/hook"
)
...
type runTimeTuningFetchHookRequest struct {
	Model          phpav1alpha1.Model                 `json:"model"`
...
func (p *Predict) GetType() string {
	return phpav1alpha1.TypeHoltWinters
}

func (p *Predict) validate(model *phpav1alpha1.Model) error {
