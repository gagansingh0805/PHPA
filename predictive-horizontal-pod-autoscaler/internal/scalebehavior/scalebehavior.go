...
func DecideTargetReplicasByScalingStrategy(decisionType string, predictedReplicas []int32) int32 {
	...
	switch decisionType {
	case phpav1alpha1.DecisionMaximum:
		max := int32(0)
		...
		targetReplicas = max
	case phpav1alpha1.DecisionMinimum:
		min := int32(0)
		for i, predictedReplica := range predictedReplicas {
		...
		targetReplicas = min
	case phpav1alpha1.DecisionMean:
		total := int32(0)
	...
	case phpav1alpha1.DecisionMedian:
...
func DecideTargetReplicasByBehavior(
	...
	scaleUpReplicaHistory []phpav1alpha1.TimestampedReplicas,
	scaleDownReplicaHistory []phpav1alpha1.TimestampedReplicas,
	scaleUpEventHistory []phpav1alpha1.TimestampedReplicas,
	scaleDownEventHistory []phpav1alpha1.TimestampedReplicas,
	now time.Time) int32 {
...
func PruneTimestampedReplicasToWindow(
	timestampedReplicas []phpav1alpha1.TimestampedReplicas, window int32, now time.Time) []phpav1alpha1.TimestampedReplicas {

	prunedTimestampedReplicas := []phpav1alpha1.TimestampedReplicas{}
...
func decideTargetReplicasByBehaviorRate(behavior *autoscalingv2.HorizontalPodAutoscalerBehavior,
	...
	scaleUpEvents []phpav1alpha1.TimestampedReplicas,
	scaleDownEvents []phpav1alpha1.TimestampedReplicas, now time.Time) int32 {
...
func calculateScaleUpLimitWithinScalingRules(currentReplicas int32,
	scaleUpEvents []phpav1alpha1.TimestampedReplicas,
	scaleDownEvents []phpav1alpha1.TimestampedReplicas,
...
func getReplicaChanges(scaleEvents []phpav1alpha1.TimestampedReplicas, periodSeconds int32, now time.Time) int32 {
